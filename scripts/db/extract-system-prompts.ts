...
async function main() {
  ...
  try {
    ...
    if (typeof system1 === 'string') {
      ...
      console.log(`Starts with CLI tool prefix: ${system1.trim().startsWith('You are an interactive CLI tool')}`)
    } else {
    ...
    if (typeof system2 === 'string') {
      ...
      console.log(`Starts with CLI tool prefix: ${system2.trim().startsWith('You are an interactive CLI tool')}`)
    } else {
